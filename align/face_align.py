...
class MTCNNFaceAlignment:
    def __init__(self,crop_size = 112):
        self._crop_size = crop_size
        scale = crop_size / 112.
        self._reference = get_reference_facial_points(default_square=True) * scale

    def align(self, image, landmark_5):
        return warp_and_crop_face(image, landmark_5,self._reference, crop_size=(self._crop_size,self._crop_size))
